    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span> <a href="{{route('category',$product->categories[0])}}">{{$product->categories[0]->name}}</a> <span></span> {{$product->name}}
            </div>
        </div>
    </div>
                            ...
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <div class="clearfix product-price-cover">
                                    <div class="product-price primary-color float-left">
                                        <span class="current-price text-brand">{{$product->special_price ?? $product->price}}</span>
                                        <span>
                                        ...
                                        <div class="product-cart-wrap hover-up">
                                            <div class="product-img-action-wrap">
                                                <div class="product-img product-img-zoom">
                                                    <a href="{{route('product_details',$product)}}" tabindex="0">
                                            ...
                                            <div class="product-content-wrap">
                                                <h2><a href="{{route('product_details',$product)}}" tabindex="0">{{$product->name}}</a></h2>
                                                <div class="rating-result" title="90%">
                                                    <span> </span>
                                                </div>
                                                <div class="product-price">
                                                    <span>${{$product->special_price ?? $product->price}}</span>
                                                    @if($product->special_price)
