                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.product.price.update',$product)}}"
                                              method="POST"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="special_price_type" class="select2 form-control">
                                                                <optgroup label="من فضلك أختر النوع ">
                                                                    <option {{$product?->special_price_type == 'percent' ? 'selected' : ''}} value="percent">percent</option>
                                                                    <option {{$product?->special_price_type == 'fixed' ? 'selected' : ''}} value="fixed">fixed</option>
                                                                </optgroup>
                                                            </select>
